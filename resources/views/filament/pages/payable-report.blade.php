<x-filament-panels::page>
        ...
        <div class="mt-6 space-y-4">
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                ...
                <div class="bg-white rounded-xl shadow-sm border p-4 dark:bg-gray-800">
                    ...
                    <p class="text-lg font-bold text-gray-800 mt-1">{{ $report['supplier_count'] }}</p>
                </div>
                <div class="bg-white rounded-xl shadow-sm border p-4 dark:bg-gray-800">
                    <p class="text-xs font-medium text-gray-500">Total Hutang</p>
    ...
    @else
        <div class="mt-6 bg-white rounded-xl shadow-sm border p-6 text-center dark:bg-gray-800">
            <p class="text-sm text-gray-500">Tidak ada hutang outstanding.</p>
        </div>
    @endif
</x-filament-panels::page>
